...
kubectl wait --for=condition=complete job/loki-query-job -n zenoh-monitoring --timeout=60s

LOKI_TEST_RESULT=$(kubectl logs job/loki-query-job -n zenoh-monitoring)
